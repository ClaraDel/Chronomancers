...
public class ScoreManager : MonoBehaviour
{
    ...
    [Space]
    [Header("Coordonn�es des zones de contr�le :")]
    public int hauteurArea;
    public int largeurArea;
    public int coordXArea1; //positionX de la case en bas � gauche de l'area1
    public int coordYArea1; //positionY de la case en bas � gauche de l'area1
    ...
    void UpdateScore(int value, int team)
    {
        ...
        //Pour plus tard potentiellement : cr�er un struct de team regroupant toutes les infos sur l'�quipe (personnalisation)
    }
